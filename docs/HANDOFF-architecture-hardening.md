...
2. 服务器源码级归档已创建：`<SERVER_PATH>`，SHA-256 为 `e59e3877ae0a5662dae75e96a05927643d06e68d350ae5e0b2eef5bc262c0ecb`。同目录还包含 `worktree.status`、`worktree.diff`、`untracked.list`、`SCOPE.txt` 与 `SHA256SUMS`。
