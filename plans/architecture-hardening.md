...
- Handoff: `docs/HANDOFF-architecture-hardening.md` records the local verification, server dirty-worktree gate, storage limit, and next-machine continuation steps. A source-only server archive and Git bundle are pending creation/verification.
