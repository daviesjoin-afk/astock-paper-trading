...
Current release: **v1.2.0**. See [release notes](docs/RELEASE-v1.2.0.md) and [security boundaries](SECURITY.md). CI covers Python 3.11/3.12. The historical API version 2.0.0 is not the release tag.
